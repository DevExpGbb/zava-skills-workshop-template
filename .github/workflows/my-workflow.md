...
1. Locate `target-app/` at the repo root. If missing, post a comment
   explaining and stop.
2. Invoke the `my-skill` skill against `target-app/`. Follow its
...
- Do **not** modify files outside `target-app/`.
