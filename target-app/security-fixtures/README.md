...
> **Banking / regulated audiences:** this is a workshop fixture. The vulnerable versions are pinned for pedagogical reasons. Production builds of `target-app/` do **not** depend on this folder. The Track 3 skill audits **this fixture only**.
...
```bash
cd target-app/security-fixtures
